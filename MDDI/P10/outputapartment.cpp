...
void OutputApartment::updateList(SqliteDBManager *sqliteDBManager)
{
...
//    }
    ...
    qSqlTableModel->setTable(sqliteDBManager->APARTMENT_NAME);
    qSqlTableModel->select();
    ui->ApartmentTV->setModel(qSqlTableModel);
}
